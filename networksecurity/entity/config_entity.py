...
class DataValidationConfig:
    def __init__(self,training_pipeline_cofig:TrainingPipelineConfig):
        self.data_validation_dir=os.path.join(training_pipeline_cofig.artifact_dir,training_pipeline.DATA_VALIDATION_DIR_NAME)
        ...
        self.valid_train_file_path=os.path.join(self.valid_data_dir,training_pipeline.TRAIN_DATA_FILE)
        self.valid_test_file_path=os.path.join(self.valid_data_dir,training_pipeline.TEST_DATA_FILE)
        self.invalid_train_file_path=os.path.join(self.invalid_data_dir,training_pipeline.TRAIN_DATA_FILE)
        self.invalid_test_file_path=os.path.join(self.invalid_data_dir,training_pipeline.TEST_DATA_FILE)
        self.data_drift_report_file_path=os.path.join(
...
class DataTransformationConfig:
    def __init__(self,training_pipeline_config:TrainingPipelineConfig):
        ...
        self.transformed_trained_file_path=os.path.join(self.data_transformation_dir,training_pipeline.DATA_TRANSFORMATION_TRANSFORMED_DATA_DIR,
                                                        training_pipeline.TRAIN_DATA_FILE.replace("csv","npy"))
        self.transformed_test_file_path=os.path.join(
            self.data_transformation_dir,training_pipeline.DATA_TRANSFORMATION_TRANSFORMED_DATA_DIR,
            training_pipeline.TEST_DATA_FILE.replace("csv","npy")
        )
        ...
        self.transformed_object_file_path=os.path.join(self.data_transformation_dir,training_pipeline.DATA_TRANSFORMATION_TRANSFORMED_OBJECT_DIR,
                                                       training_pipeline.TRANSFORMER_OBJECT_FILE)
...
class ModelTrainerConfig:
    def __init__(self,training_pipeline_config:TrainingPipelineConfig):
        ...
        self.overfitting_underfitting_score:float=training_pipeline.MODEL_TRAINER_OVERFITTING_AND_UNDERFITTING_THRESHOLD
